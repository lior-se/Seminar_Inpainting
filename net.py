...
class PConvUNet(nn.Module):
    def __init__(self, layer_size=7, input_channels=3, upsampling_mode='nearest'):
        ...
        self.enc_1 = PCBActiv(input_channels, 64, bn=False, sample='down-7')
        print("Initialized enc_1")
        self.enc_2 = PCBActiv(64, 128, sample='down-5')
        print("Initialized enc_2")
        self.enc_3 = PCBActiv(128, 256, sample='down-5')
        print("Initialized enc_3")
        self.enc_4 = PCBActiv(256, 512, sample='down-3')
        print("Initialized enc_4")
        ...
        self.dec_4 = PCBActiv(512 + 256, 256, activ='leaky')
        print("Initialized dec_4")
        self.dec_3 = PCBActiv(256 + 128, 128, activ='leaky')
        print("Initialized dec_3")
        self.dec_2 = PCBActiv(128 + 64, 64, activ='leaky')
        print("Initialized dec_2")
        self.dec_1 = PCBActiv(64 + input_channels, input_channels, bn=False, activ=None, conv_bias=True)
        print("Initialized dec_1")

        print("PConvUNet initialization done")
